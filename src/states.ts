...
export const STATE_REQS: StateReq[] = [
  { code: 'AL', name: 'Alabama', totalHours: 50, nightHours: 0, note: 'Waived with an approved driver-ed course.' },
  { code: 'AK', name: 'Alaska', totalHours: 40, nightHours: 10, note: 'Night hours may be at night or in bad weather.' },
  { code: 'AZ', name: 'Arizona', totalHours: 30, nightHours: 10, note: 'Waived with an approved driver-ed course.' },
  ...
  { code: 'KS', name: 'Kansas', totalHours: 50, nightHours: 10, note: '25 in the learner phase, 25 more before 16.' },
  ...
  { code: 'MN', name: 'Minnesota', totalHours: 40, nightHours: 15 },
  ...
  { code: 'NE', name: 'Nebraska', totalHours: 50, nightHours: 10, note: 'Waived with an approved driver-ed course.' },
  { code: 'NV', name: 'Nevada', totalHours: 50, nightHours: 10, note: 'Waived with an approved defensive-driving course.' },
  { code: 'NH', name: 'New Hampshire', totalHours: 40, nightHours: 10 },
  { code: 'NJ', name: 'New Jersey', totalHours: 50, nightHours: 10 },
  ...
  { code: 'ND', name: 'North Dakota', totalHours: 50, nightHours: 0, note: 'Applies to drivers under 16.' },
  ...
  { code: 'PA', name: 'Pennsylvania', totalHours: 65, nightHours: 10, note: 'Plus 5 hours in inclement weather.' },
  { code: 'RI', name: 'Rhode Island', totalHours: 50, nightHours: 10 },
  { code: 'SC', name: 'South Carolina', totalHours: 40, nightHours: 10 },
  { code: 'SD', name: 'South Dakota', totalHours: 50, nightHours: 10, note: 'Plus 10 hours in inclement weather.' },
  ...
  { code: 'WV', name: 'West Virginia', totalHours: 50, nightHours: 10, note: 'Waived with an approved driver-ed course.' },
