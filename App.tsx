...
function Shell() {
  ...
  return (
    <LockGate>
      <View style={{ flex: 1, backgroundColor: theme.bg, paddingTop: insets.top }}>
        <View style={{ flex: 1 }}>
          {tab === 'drives' && <HomeScreen onAddDrive={openNewDrive} onOpenDrive={openDrive} />}
          {tab === 'log' && <ReportScreen />}
